    ...
    <div class="flex h-screen overflow-hidden">
        <aside class="w-64 bg-slate-800 text-white flex flex-col flex-shrink-0">
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                ...
                <div class="pt-3 pb-1">
                    <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider px-3">Gestión</p>
                </div>
                ...
                <div class="pt-3 pb-1">
                    <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider px-3">Cobros</p>
                </div>
        ...
        <div class="flex-1 flex flex-col min-h-0 overflow-hidden">
            <header class="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                ...
                <div class="text-sm text-gray-500">{{ config('app.name') }}</div>
            </header>
