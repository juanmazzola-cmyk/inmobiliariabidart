                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-center gap-1">
                                    ...
                                    @if (in_array($c->estado, ['activo', 'vencido']))
                                        <button @click="$store.confirm.open(() => $wire.rescindir({{ $c->id }}), { titulo: '¿Rescindir contrato?', mensaje: 'La propiedad volverá a estar disponible. Los pagos y liquidaciones se conservan.', accionLabel: 'Rescindir', colorBtn: 'orange' })"
                                    ...
                                    <button @click="$store.confirm.open(() => $wire.eliminar({{ $c->id }}), { mensaje: 'Se borrarán TODOS sus pagos y liquidaciones. Esta acción no se puede deshacer.' })"
