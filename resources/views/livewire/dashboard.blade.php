<div class="space-y-6">
    ...
    <div class="relative z-10 grid grid-cols-3 gap-4">
        <a href="{{ route('propiedades.index') }}" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md hover:border-blue-200 transition-all">
            <div class="flex items-start justify-between">
                <div>
                    <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide">Alquileres</p>
                    <p class="text-2xl font-bold text-gray-900 mt-1">{{ $totalPropiedades }}</p>
                    <p class="text-xs text-gray-400 mt-1">{{ $propiedadesAlquiladas }} alquiladas · {{ $propiedadesDisponibles }} libres</p>
                </div>
                <div class="bg-blue-100 p-2 rounded-xl shrink-0">
        ...
        <a href="{{ route('propiedades-venta.index') }}" class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 hover:shadow-md hover:border-indigo-200 transition-all">
            <div class="flex items-start justify-between">
                <div>
